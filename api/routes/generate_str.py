"""
This module defines the /generate-str endpoint for the API,
which takes a prompt and optional context and returns the LLM response.
"""
...
async def generate_str(request: Request):
    """
    /generate-str endpoint that takes a JSON body with:
    ...
    try:
        return await get_llm_response_str(prompt=final_prompt)
